...
from model import BertForSequenceClassificationWithDP, BertForSequenceClassificationDistil, Attackers
...
MODEL_CLASSES = {
    ...
    "dpbert": (BertConfig, BertForSequenceClassificationWithDP, BertTokenizer),
...
def attack(args, train_dataset, model, tokenizer, config):
    """ Train the model """
...
def main():
    ...
    if args.do_train:
        ...
        _, _, attacker = attack(args, train_dataset, model, tokenizer, config)
